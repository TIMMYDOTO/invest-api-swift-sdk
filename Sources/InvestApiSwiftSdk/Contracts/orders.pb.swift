...
public enum Tinkoff_Public_Invest_Api_Contract_V1_OrderDirection: SwiftProtobuf.Enum, Swift.CaseIterable {
...
///Тип заявки.
public enum Tinkoff_Public_Invest_Api_Contract_V1_OrderType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_OrderExecutionReportStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_TimeInForceType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Tinkoff_Public_Invest_Api_Contract_V1_TimeInForceType] = [
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_OrderIdType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Tinkoff_Public_Invest_Api_Contract_V1_OrderIdType] = [
    .unspecified,
    .exchange,
    .request,
  ]
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_TradesStreamRequest: Sendable {
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_TradesStreamResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация об исполнении торгового поручения.
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderTrades: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация о сделке.
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderTrade: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostOrderResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostOrderAsyncRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostOrderAsyncResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_CancelOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_CancelOrderResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrderStateRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderState: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderStage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_ReplaceOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMaxLotsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMaxLotsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct BuyLimitsView: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct SellLimitsView: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrderPriceRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrderPriceResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_InstrumentExtra: Equatable, Sendable {
    ///Дополнительная информация по облигациям
  ...
  public struct ExtraBond: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct ExtraFuture: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderStateStreamRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscriptionResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderStateStreamResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Маркер
  public enum MarkerType: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Tinkoff_Public_Invest_Api_Contract_V1_OrderStateStreamResponse.MarkerType] = [
      .markerUnknown,
      .markerBroker,
      .markerChat,
      .markerPaper,
  ...
  public enum StatusCauseInfo: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Tinkoff_Public_Invest_Api_Contract_V1_OrderStateStreamResponse.StatusCauseInfo] = [
      .causeUnspecified,
  ...
  ///Заявка
  public struct OrderState: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
