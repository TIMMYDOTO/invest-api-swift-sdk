...
///Тип стратегии.
public enum Tinkoff_Public_Invest_Api_Contract_V1_StrategyType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
///Направление сигнала.
public enum Tinkoff_Public_Invest_Api_Contract_V1_SignalDirection: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Статус сигнала.
public enum Tinkoff_Public_Invest_Api_Contract_V1_SignalState: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Запрос стратегий.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetStrategiesRequest: Sendable {
...
///Стратегии
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetStrategiesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Стратегия
public struct Tinkoff_Public_Invest_Api_Contract_V1_Strategy: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Запрос сигналов.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetSignalsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Сигналы.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetSignalsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Сигнал.
public struct Tinkoff_Public_Invest_Api_Contract_V1_Signal: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
