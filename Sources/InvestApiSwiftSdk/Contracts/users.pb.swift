...
///Тип счeта.
public enum Tinkoff_Public_Invest_Api_Contract_V1_AccountType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
///Статус счeта.
public enum Tinkoff_Public_Invest_Api_Contract_V1_AccountStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_AccessLevel: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetAccountsRequest: Sendable {
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetAccountsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация о счeте.
public struct Tinkoff_Public_Invest_Api_Contract_V1_Account: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMarginAttributesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMarginAttributesResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetUserTariffRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetUserTariffResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Лимит unary-методов.
public struct Tinkoff_Public_Invest_Api_Contract_V1_UnaryLimit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_StreamLimit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetInfoResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
