...
public enum Tinkoff_Public_Invest_Api_Contract_V1_SubscriptionAction: SwiftProtobuf.Enum, Swift.CaseIterable {
...
///Интервал свечи.
public enum Tinkoff_Public_Invest_Api_Contract_V1_SubscriptionInterval: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Результат подписки.
public enum Tinkoff_Public_Invest_Api_Contract_V1_SubscriptionStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_TradeSourceType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Направление сделки.
public enum Tinkoff_Public_Invest_Api_Contract_V1_TradeDirection: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_CandleInterval: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_CandleSource: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_MarketValueType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Tinkoff_Public_Invest_Api_Contract_V1_MarketValueType] = [
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_OrderBookType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Тип последней цены
public enum Tinkoff_Public_Invest_Api_Contract_V1_LastPriceType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_MarketDataRequest: Sendable {
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_MarketDataServerSideStreamRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_MarketDataResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeCandlesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_CandleInstrument: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeCandlesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_CandleSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeOrderBookRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Запрос подписки на стаканы.
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderBookInstrument: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeOrderBookResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Статус подписки.
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderBookSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeTradesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_TradeInstrument: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeTradesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Статус подписки.
public struct Tinkoff_Public_Invest_Api_Contract_V1_TradeSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_InfoInstrument: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeInfoResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Статус подписки.
public struct Tinkoff_Public_Invest_Api_Contract_V1_InfoSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeLastPriceRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_LastPriceInstrument: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_SubscribeLastPriceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_LastPriceSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_Candle: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_OrderBook: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_Order: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация о сделке.
public struct Tinkoff_Public_Invest_Api_Contract_V1_Trade: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_TradingStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetCandlesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Список свечей.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetCandlesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация о свече.
public struct Tinkoff_Public_Invest_Api_Contract_V1_HistoricCandle: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetLastPricesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetLastPricesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_LastPrice: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_OpenInterest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Запрос стакана.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrderBookRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrderBookResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetTradingStatusRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Запрос получения торгового статуса.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetTradingStatusesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetTradingStatusesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация о торговом статусе.
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetTradingStatusResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetLastTradesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetLastTradesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMySubscriptions: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetClosePricesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_InstrumentClosePriceRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetClosePricesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_InstrumentClosePriceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetTechAnalysisRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetTechAnalysisResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMarketValuesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetMarketValuesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_MarketValueInstrument: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_MarketValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
