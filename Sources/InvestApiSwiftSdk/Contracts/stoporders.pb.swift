...
public enum Tinkoff_Public_Invest_Api_Contract_V1_StopOrderDirection: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_StopOrderExpirationType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Тип стоп-заявки.
public enum Tinkoff_Public_Invest_Api_Contract_V1_StopOrderType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Статус стоп-заяки.
public enum Tinkoff_Public_Invest_Api_Contract_V1_StopOrderStatusOption: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_ExchangeOrderType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_TakeProfitType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_TrailingValueType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public enum Tinkoff_Public_Invest_Api_Contract_V1_TrailingStopStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostStopOrderRequest: @unchecked Sendable {
  ...
  public struct TrailingData: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostStopOrderResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetStopOrdersRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetStopOrdersResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_CancelStopOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_CancelStopOrderResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_StopOrder: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
